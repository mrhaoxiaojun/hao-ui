...
---
 Markdown 文件转成 Vue 组件

## 相关依赖

```bash
> cnpm i -S  vue-markdown-loader cheerio markdown-it-anchor markdown-it-container  highlight.js transliteration
> cnpm i -S  stylus stylus-loader 
