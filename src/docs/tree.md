...
<div class="demo-block">
  <h-tree :data="data" show-checkbox multiple allow-batch whole-row @item-click="itemClick"></h-tree>
</div>
<script>
  export default {
    data () {
  ...
  <h-tree :data="data">
    <template slot-scope="_">
      <div style="display: inherit; width: 200px" @click.ctrl="customItemClickWithCtrl">
        ...
        {{_.model.text}}
        <button style="border: 0px; background-color: transparent; cursor: pointer;" @click="customItemClick(_.vm, _.model, $event)"><i class="fa fa-remove">xxx(自定义元素)</i></button>
      </div>
    </template>
  </h-tree>
</div>
...
[开源源码DEMO](https://github.com/zdy1988/vue-jstree)  
[开源源码地址](https://github.com/zdy1988/vue-jstree#readme)  
由于开源作者长期没有再维护了，个人需求上有一些变更，所以下载了源码进行了二次修改，开源万岁